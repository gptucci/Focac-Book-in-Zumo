...
namespace Focac_BookService.Controllers
{
    public class FocaccePostController : TableController<FocaccePost>
    {
        protected override void Initialize(HttpControllerContext controllerContext)
        {
            ...
            //Il terzo parametro, enableSoftDelete, ora è posto a True
            //server per abilitare il soft delete
            DomainManager = new EntityDomainManager<FocaccePost>(context, Request,true);

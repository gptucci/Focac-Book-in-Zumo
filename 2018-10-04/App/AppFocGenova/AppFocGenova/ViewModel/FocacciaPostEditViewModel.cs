    ...
    public class FocacciaPostEditViewModel : BaseViewModel
    {
        ...
        private async Task SalvaFocacciPostAsync()
        {
            ...
            try
            {
                ...
                {
                    //Siamo in editing
                    focaccePostInEditing.NomeUtente = Settings.UserId;
        ...
        private async Task CancellaFocacciPostAsync()
        {
            ...
            if (!await App.Current.MainPage.DisplayAlert("", "Sei sicuro di voler cancellare ?", "Yes", "No"))
            {
                return;
            }
